...
const EditProfile = ({ navigation }) => {
  ...
  async function editProfile(formData: FormDataEditProfileInterface) {
    ...
    try {
      ...
      // for non restful api
      const data: EditProfileResponseInterface  = (await axios.post(`${profileUrl}-2/${state.id_pengguna}`, JSON.stringify(formData))).data;
  ...
  return (
    <DismissKeyboard>
      <WithTopNavigation safeArea name="Edit Profil" bgColor="light.50">
